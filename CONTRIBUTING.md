# Contributing to blackroad-deploy
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-deploy.git
cd blackroad-deploy

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-deploy.git
